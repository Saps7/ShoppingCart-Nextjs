    ...
    return (
        <Modal isOpen={open} onClose={handleClose}>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <p className="w-[250px] text-center font-normal text-gray-600">
                    Your order is ready! Confirm the details and place your order.
                </p>
                <h3 className="w-[250px] text-center font-semibold py-4 mt-4 text-xl text-gray-700">
