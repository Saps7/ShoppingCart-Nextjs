    ...
    return (
        <header className="bg-white">
            <div className="container mx-auto px-4 py-8 flex items-center">
                ...
                {/* Logo */}
                <div className="mr-auto sm:w-48 flex-shrink-0">
                    <img className="h-8 md:h-10" src=""alt="" />
                </div>

                {/* Search */}
                <div className="w-full h-10 max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden sm:flex items-center">
                    {/* <select className="bg-transparent uppercase font-bold text-sm p-4 mr-4">
                        <option>all categories</option>
                    </select> */}
                    <input
                        className="border-l border-gray-300 bg-transparent font-semibold text-md pl-4"
                        type="text"
